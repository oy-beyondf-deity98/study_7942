...
<div class="content">
<div class="page_name">권한정보 수정</div>
<!-- commandName 는 폼에 적용할 모델의 이름을 정의한다.    -->
<form:form commandName="auth" method="POST" action="${contextPath}/admin/auth/auth_update">
	<form:hidden path="auth_seq"/>
...
<script src="${jsPath}/routine/admin/auth/auth_update.js"></script>
