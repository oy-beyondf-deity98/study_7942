...
<form:form commandName="menu" method="POST" action="${contextPath}/admin/menu/menu_update">
	<table class="input_form">
		<tbody>
		    <tr>
		        <th>메뉴명</th>
		        <td><form:input path="menu_nm" /><form:hidden path="menu_seq"/> </td>
		        <td><form:errors path="menu_nm" id="menu_nm" cssClass="errorMsg"></form:errors></td>
		    </tr>
		    <tr>
		        <th>메뉴URL</th>
...
<script src="${jsPath}/routine/admin/menu/menu_update.js?ver=1.5"></script>
